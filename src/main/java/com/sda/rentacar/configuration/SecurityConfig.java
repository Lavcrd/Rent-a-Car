package com.sda.rentacar.configuration;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE).hasAnyAuthority(Role.ROLE_EMPLOYEE.name(), Role.ROLE_MANAGER.name(), Role.ROLE_COORDINATOR.name(), Role.ROLE_DIRECTOR.name(), Role.ROLE_ADMIN.name())
                ...
                .antMatchers("/mg-cus/**").hasAnyAuthority(Role.ROLE_EMPLOYEE.name(), Role.ROLE_MANAGER.name(), Role.ROLE_COORDINATOR.name(), Role.ROLE_DIRECTOR.name(), Role.ROLE_ADMIN.name())
                ...
                .antMatchers("/overview/statistics/**").hasAnyAuthority(Role.ROLE_COORDINATOR.name(), Role.ROLE_DIRECTOR.name(), Role.ROLE_ADMIN.name())
                ...
                .antMatchers("/mg-emp/**").hasAnyAuthority(Role.ROLE_MANAGER.name(), Role.ROLE_COORDINATOR.name(), Role.ROLE_DIRECTOR.name(), Role.ROLE_ADMIN.name())
                .antMatchers("/archive/**").hasAnyAuthority(Role.ROLE_MANAGER.name(), Role.ROLE_COORDINATOR.name(), Role.ROLE_DIRECTOR.name(), Role.ROLE_ADMIN.name())
