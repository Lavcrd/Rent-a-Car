...
public class PredefiniedData implements CommandLineRunner {
    ...
    private void createRent() {
        rentRepository.save(new Rent(1L, reservationRepository.findById(1L).get(), 12L, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", LocalDate.now(), 100000L));
        rentRepository.save(new Rent(2L, reservationRepository.findById(2L).get(), 13L, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", LocalDate.now(), 100000L));
        rentRepository.save(new Rent(3L, reservationRepository.findById(3L).get(), 14L, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", LocalDate.now(), 100000L));
        rentRepository.save(new Rent(4L, reservationRepository.findById(4L).get(), 14L, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", LocalDate.now(), 100000L));
    ...
    private void createRetrieve() {
        ...
        retrieveRepository.save(new Retrieve(2L, rentRepository.findById(2L).get(), 14L, LocalDate.now().plusDays(8), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", departmentRepository.findById(2L).get(), 120000L));
        retrieveRepository.save(new Retrieve(3L, rentRepository.findById(3L).get(), 15L, LocalDate.now().plusDays(9), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", departmentRepository.findById(3L).get(), 120000L));
        retrieveRepository.save(new Retrieve(4L, rentRepository.findById(4L).get(), 11L, LocalDate.now().plusDays(10), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent imperdiet euismod ex, eget luctus lorem cursus vitae. Morbi mattis vel diam vitae hendrerit. Vivamus efficitur, elit vel pulvinar bibendum, enim. ", departmentRepository.findById(4L).get(), 120000L));
